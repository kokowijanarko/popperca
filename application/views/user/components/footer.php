						...
						<div class="col-md-2 hidden-sm">
							<div class="single-snap-footer">
								...
								<div class="cakewalk-footer-content social-footer">
									<ul>
										<li><a href="<?php echo base_url();?>assets/theme/lavoro/https://www.facebook.com/" target="_blank"><i class="fa fa-facebook"></i></a><span> Facebook</span></li>
										<li><a href="<?php echo base_url();?>assets/theme/lavoro/https://plus.google.com/" target="_blank"><i class="fa fa-google-plus"></i></a><span> Google Plus</span></li>
										<li><a href="<?php echo base_url();?>assets/theme/lavoro/https://twitter.com/" target="_blank"><i class="fa fa-twitter"></i></a><span> Twitter</span></li>
										<li><a href="<?php echo base_url();?>assets/theme/lavoro/https://youtube.com/" target="_blank"><i class="fa fa-youtube-play"></i></a><span> Youtube</span></li>
									</ul>
								</div>
							</div>
						</div>
