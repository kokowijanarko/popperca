					...
					<div class="col-md-6 col-xs-12">
						<div class="customer-login my-account">
							<form method="post" class="login" action="<?php echo base_url('index.php/user/login/do_login')?>">
								<input type="hidden" name="custommer_id" value="<?php echo $account->custommer_id?>">
								<div class="form-fields">
									<h2>Login</h2>
									<p class="form-row form-row-wide">
										<label for="username">Full Name </label>
										<input type="text" class="input-text" name="custommer_name" value="<?php echo $account->custommer_name?>">
									</p>
									<p class="form-row form-row-wide">
										<label for="username">Address </label>
										<input type="text" class="input-text" name="custommer_address" value="<?php echo $account->custommer_address?>">
									</p>
									<p class="form-row form-row-wide">
										<label for="username">Username </label>
										<input type="text" class="input-text" name="custommer_username" id="username" value="<?php echo $account->custommer_username?>">
									</p>
									<p class="form-row form-row-wide">
