															...
															foreach($invoice as $inv){																
																echo'
																	<tr>
																		...
																		<td>
																			<a class="'.$inv->conf_hide.'" href="'.site_url('user/invoice/inv_confirm/'.$inv->invoice_id).'">
																				<button class="button" >Konfirmasi</button>
																			</a>
																			<a target="_blank " class="'.$inv->img_hide.'" href="'.site_url('user/invoice/img_inv_confirm/'.$inv->invoice_conf_img).'">
																				<button class="button" >Lihat Bukti Transfer</button>
																			</a>
																			<a href="#">
