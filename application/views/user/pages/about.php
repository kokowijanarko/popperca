				...
				<div class="row">
						...
						<div class="col-lg-12 col-md-12">
							...
							<div class="single-product first-sale">
								<div class="product-img">
									<img class="primary-image display-image" src="<?php echo base_url("file/about/about_1.jpg")?>" alt="" />
								</div>																				
							</div>
							<!-- single-product end -->
						</div>
					...
					<div class="col-md-12">
						...
						<div class="col-lg-12 col-md-12">
							...
							<div class="single-product first-sale">
								<div class="product-img">
									<img class="primary-image display-image" src="<?php echo base_url("file/about/about_2.jpg")?>" alt="" />
								</div>																				
							</div>
							<!-- single-product end -->
						</div>
