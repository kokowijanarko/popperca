...
<head>
    ...
    <body class="home-five">
		...
		<!-- header area start -->
		<?php
			echo $this->load->view('user/components/header');
		?>
		<!-- header area end -->
		<!-- start home slider -->
											...
											<div class="col-lg-3 col-md-3">
												...
												<div class="single-product first-sale">
													<div class="product-img">
														<a href="#">
															<img class="primary-image" src="<?php echo base_url()?>assets/theme/lavoro/img/products/product-1.jpg" alt="" />
															<img class="secondary-image" src="<?php echo base_url()?>assets/theme/lavoro/img/products/product-2.jpg" alt="" />
														</a>
										...
										<div class="features-curosel">
											<div class="col-lg-12 col-md-12">
												...
												<div class="single-product first-sale">
													...
													<div class="product-img">
														<a href="#">
															<img class="primary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-13.jpg" alt="" />
															<img class="secondary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-2.jpg" alt="" />
														</a>
														<div class="action-zoom">
															<div class="add-to-cart">
												...
												<div class="single-product">
													<div class="product-img">
														<a href="#">
															<img class="primary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-8.jpg" alt="" />
															<img class="secondary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-12.jpg" alt="" />
														</a>
														<div class="action-zoom">
															<div class="add-to-cart">
																<a href="#" title="Quick View"><i class="fa fa-search-plus"></i></a>
											...
											<div class="col-lg-12 col-md-12">
												...
												<div class="single-product first-sale">
													<div class="product-img">
														<a href="#">
															<img class="primary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-6.jpg" alt="" />
															<img class="secondary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-12.jpg" alt="" />
														</a>
														<div class="action-zoom">
															<div class="add-to-cart">
											...
											<div class="col-lg-12 col-md-12">
												...
												<div class="single-product first-sale">
													<div class="product-img">
														<a href="#">
															<img class="primary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-11.jpg" alt="" />
															<img class="secondary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-9.jpg" alt="" />
														</a>
														<div class="action-zoom">
															<div class="add-to-cart">
																<a href="#" title="Quick View"><i class="fa fa-search-plus"></i></a>
												...
												<div class="single-product">
													...
													<div class="product-img">
														<a href="#">
															<img class="primary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-9.jpg" alt="" />
															<img class="secondary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-12.jpg" alt="" />
														</a>
														<div class="action-zoom">
															<div class="add-to-cart">
											...
											<div class="col-lg-12 col-md-12">
												...
												<div class="single-product first-sale">
													<div class="product-img">
														<a href="#">
															<img class="primary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-1.jpg" alt="" />
															<img class="secondary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-1.jpg" alt="" />
														</a>
														<div class="action-zoom">
															<div class="add-to-cart">
																<a href="#" title="Quick View"><i class="fa fa-search-plus"></i></a>
												...
												<div class="single-product">
													<div class="product-img">
														<a href="#">
															<img class="primary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-12.jpg" alt="" />
															<img class="secondary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-3.jpg" alt="" />
														</a>
														<div class="action-zoom">
															<div class="add-to-cart">
																<a href="#" title="Quick View"><i class="fa fa-search-plus"></i></a>
											...
											<div class="col-lg-12 col-md-12">
												...
												<div class="single-product first-sale">
													<div class="product-img">
														<a href="#">
															<img class="primary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-4.jpg" alt="" />
															<img class="secondary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-5.jpg" alt="" />
														</a>
														<div class="action-zoom">
															<div class="add-to-cart">
																<a href="#" title="Quick View"><i class="fa fa-search-plus"></i></a>
												...
												<div class="single-product">
													<div class="product-img">
														<a href="#">
															<img class="primary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-6.jpg" alt="" />
															<img class="secondary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-7.jpg" alt="" />
														</a>
														<div class="action-zoom">
															<div class="add-to-cart">
																<a href="#" title="Quick View"><i class="fa fa-search-plus"></i></a>
											...
											<div class="col-lg-12 col-md-12">
												...
												<div class="single-product first-sale">
													<div class="product-img">
														<a href="#">
															<img class="primary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-9.jpg" alt="" />
															<img class="secondary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-10.jpg" alt="" />
														</a>
														<div class="action-zoom">
															<div class="add-to-cart">
																<a href="#" title="Quick View"><i class="fa fa-search-plus"></i></a>
											...
											<div class="col-lg-12 col-md-12">
												...
												<div class="single-product first-sale">
													<div class="product-img">
														<a href="#">
															<img class="primary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-5.jpg" alt="" />
															<img class="secondary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-6.jpg" alt="" />
														</a>
														<div class="action-zoom">
															<div class="add-to-cart">
																<a href="#" title="Quick View"><i class="fa fa-search-plus"></i></a>
												...
												<div class="single-product">
													<div class="product-img">
														<a href="#">
															<img class="primary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-7.jpg" alt="" />
															<img class="secondary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-8.jpg" alt="" />
														</a>
														<div class="action-zoom">
															<div class="add-to-cart">
																<a href="#" title="Quick View"><i class="fa fa-search-plus"></i></a>
										...
										<div class="features-curosel">
											...
											<div class="col-lg-12 col-md-12">
												...
												<div class="single-product first-sale">
													<div class="product-img">
														<a href="#">
															<img class="primary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-3.jpg" alt="" />
															<img class="secondary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-9.jpg" alt="" />
														</a>
														<div class="action-zoom">
															<div class="add-to-cart">
											...
											<div class="col-lg-12 col-md-12">
												...
												<div class="single-product">
													<div class="product-img">
														<a href="#">
															<img class="primary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-2.jpg" alt="" />
															<img class="secondary-image" src="<?php echo base_url()?>assets/theme/lavoro/img//products/product-3.jpg" alt="" />
														</a>
														<div class="action-zoom">
															<div class="add-to-cart">
