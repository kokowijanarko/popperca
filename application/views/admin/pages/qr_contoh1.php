...
<div class="page-header">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="<?php echo base_url('index.php/qr/generate_qr')?>" method="POST">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" name="username" placeholder="Username" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea class="fcol-xs-10 col-sm-5" id="form-field-8" placeholder="Default Text" name="alamat"></textarea>
										</div>
									</div>
